...
# This project moved to [Codeberg](https://codeberg.org/ichthyosaurus/harbour-dashboard)

> [!WARNING]
> **Development of Dashboard has moved to
> [Codeberg](https://codeberg.org/ichthyosaurus/harbour-dashboard).
> Please update your bookmarks and local clones to point to the new URL.**
>
>     git remote set-url origin https://codeberg.org/ichthyosaurus/harbour-dashboard
>     git fetch
...
<img src="https://codeberg.org/ichthyosaurus/sailfish-app-assets/raw/branch/main/harbour-dashboard/banner-small.png"
     alt="Dashboard banner" />

# Dashboard for [Sailfish OS](https://sailfishos.org)
...
Forecasts, monitors, and other gadgets at a glance
  ...
  <p>
    ...
    <a href="https://hosted.weblate.org/projects/harbour-dashboard/translations">
      <img src="https://hosted.weblate.org/widgets/harbour-dashboard/-/translations/svg-badge.svg"
           alt="Translations" />
    </a>
    <a href="https://codeberg.org/ichthyosaurus/harbour-dashboard">
      <img src="https://codeberg.org/ichthyosaurus/.profile/raw/branch/main/badges/development_%20active.svg"
           alt="Development status" />
    </a>
    <a href="https://codeberg.org/ichthyosaurus/harbour-dashboard/src/branch/main/LICENSES">
    ...
    <a href="https://api.reuse.software/info/codeberg.org/ichthyosaurus/harbour-dashboard">
      <img src="https://api.reuse.software/badge/codeberg.org/ichthyosaurus/harbour-dashboard"
           alt="REUSE status" />
    </a>
    <br />
...
Dashboard is an app to give you the data you need at a glance.
...
> You can find screenshots [here](https://codeberg.org/ichthyosaurus/sailfish-app-assets/src/branch/main/harbour-dashboard/screenshots-store).
...
- `Internet`: to find location names for the world clock, and to fetch forecasts
...
[![Translations status](https://hosted.weblate.org/widget/harbour-dashboard/horizontal-auto.svg)](https://hosted.weblate.org/engage/harbour-dashboard/)

Translations are managed using
[Weblate](https://hosted.weblate.org/projects/harbour-dashboard).
Please prefer this over pull requests (which are still welcome, of course).
If you just found a minor problem, you can also
[open an issue](https://codeberg.org/ichthyosaurus/harbour-dashboard/issues/new).
...
1. Clone the repository by running `git clone --recursive https://codeberg.org/ichthyosaurus/harbour-dashboard`
2. Open `harbour-dashboard.pro` in QtCreator for Sailfish ([SailfishOS SDK](https://docs.sailfishos.org/Tools/Sailfish_SDK/))
...
The source code is available [on Codeberg](https://codeberg.org/ichthyosaurus/harbour-dashboard).
All documentation is released under the terms of the
[GNU Free Documentation License v1.3 (or later)](https://spdx.org/licenses/GFDL-1.3-or-later.html).

Dashboard and related materials must not be used for AI training and/or data mining.

This project follows the [REUSE specification](https://api.reuse.software/info/codeberg.org/ichthyosaurus/harbour-dashboard).
